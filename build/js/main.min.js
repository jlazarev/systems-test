...
/* harmony import */ var _modules_help_popup__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/help-popup */ "./js/modules/help-popup.js");
/* harmony import */ var _modules_help_popup__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_modules_help_popup__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _modules_login_popup__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/login-popup */ "./js/modules/login-popup.js");
/* harmony import */ var _modules_login_popup__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_modules_login_popup__WEBPACK_IMPORTED_MODULE_5__);
...
accordions.forEach(function (el) {
  ...
  title.addEventListener('click', function () {
    ...
    if (content.style.height) {
      ...
      el.classList.add('accordion--open'); // let paddingTop = parseInt(getComputedStyle(content).getPropertyValue('padding-top'), 10);
...
var helpBtn = document.querySelector('.header__help');
var helpPopup = document.querySelector('.header__popup');
...
var menu = document.querySelector('.header__menu'); // const body = document.querySelector('.page-body');

navToggle.addEventListener('click', function () {
  if (menu.classList.contains('header__menu--open')) {
    menu.classList.remove('header__menu--open');
    navToggle.classList.remove('header__menu-btn--open'); // body.classList.remove('page-body--no-scroll');
  } else {
    menu.classList.add('header__menu--open');
    navToggle.classList.add('header__menu-btn--open'); // body.classList.add('page-body--no-scroll');
  }
});
window.addEventListener('click', function (evt) {
